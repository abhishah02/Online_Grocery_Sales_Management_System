...
<div class="search">
   ...
   Edit Registration
    ...
    <div class="box"> 
    Name <input name="c1_uname" value="<?php echo $row->USER_NAME?>" type="text" id="c1_uname" class="field" style="width:206px;" />
        <span id="c1_Req_txtname" style="color:#CC0000;visibility:hidden;">Required</span>
        <br /> 
    <label>Mobile Number </label>
    <input name="c1_mnumber" type="text" value="<?php echo $row->USER_NUMBER?>" maxlength="10" id="c1_mnumber" class="field" style="width:206px;" />
    <span id="c1_req_mn" style="color:#CC0000;visibility:hidden;">Enter 10 Digites</span>
    
     <label>Address</label>
    <textarea name="c1_address"  value="<?php echo $row->USER_ADDRESS?>" rows="5" cols="10" id="c1_uadd" class="field" style="width:206px;"></textarea>
